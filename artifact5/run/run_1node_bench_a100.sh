...
lmpdate=4Feb25
lmpexe=lmp_a100_kokkos_gpu
machine=a100

# Default nodes of Perlmutter from April 4th, 2025 work for LAMMPS-KOKKOS build and run.

# OpenMP settings from https://docs.nersc.gov/jobs/jobscript-generator/
