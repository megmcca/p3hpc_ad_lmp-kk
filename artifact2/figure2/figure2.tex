...
\begin{tikzpicture}[overlay=false,>=latex]
    \begin{groupplot}[
            ...
            \addplot+[mark=*]  table {thread_h100_off.txt};
            \addlegendentry{off};
            \addplot+[mark=*]  table {thread_h100_on.txt};
            \addlegendentry{on};
            \addlegendimage{empty legend};
            \addlegendentry{\hspace{-0.65cm}MI250X};
            \pgfplotsset{cycle list/Blues-5}
            \pgfplotsset{cycle list shift=0}
            \addplot+[mark=square*]  table {thread_mi250x_off.txt};
            \addlegendentry{off};
            \addplot+[mark=square*]  table {thread_mi250x_on.txt};
            \addlegendentry{on};
            ...
            \addplot+[mark=*]  table {neigh_h100_full.txt};
            \addlegendentry{full};
            \addplot+[mark=*]  table {neigh_h100_half_off.txt};
            \addlegendentry{half, off};
            \addplot+[mark=*]  table {neigh_h100_half_on.txt};
            ...
            \addplot+[mark=square*]  table {neigh_mi250x_full.txt};
            \addlegendentry{full};
            \addplot+[mark=square*]  table {neigh_mi250x_half_off.txt};
            \addlegendentry{half, off};
            \addplot+[mark=square*]  table {neigh_mi250x_half_on.txt};
            \addlegendentry{half, on};
    \end{groupplot}
\end{tikzpicture}
\else
